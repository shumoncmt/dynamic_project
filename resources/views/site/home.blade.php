...
<!-- About End -->
        ...
        <div class="container">
            ...
            <div class="col-md-4 col-sm-8 service-info">
                <div class="item"><a href={{Route('roandufmembrane')}} class="post-image view image_hover"><img src="img/product/Dynamic-Ro-membrane.jpg" alt="" class="img-responsive zoom_img_effect"></a><a href={{Route('roandufmembrane')}}>
            ...
            <div class="col-md-4 col-sm-8 service-info">
                <div class="item"><a href={{Route('industrialpump')}} class="post-image view image_hover">		<img src="img/product/Dynamic-pump.jpg" alt="" class="img-responsive zoom_img_effect"></a><a href={{Route('industrialpump')}}>
            ...
            <div class="row">
            <div class="col-md-4 col-sm-8 service-info">
                <div class="item"><a href={{Route('blower')}} class="post-image view image_hover"><img src="img/product/Dynamic-Blower.jpg" alt="" class="img-responsive zoom_img_effect"></a><a href={{Route('blower')}}>
            ...
            <div class="col-md-4 col-sm-8 service-info">
                <div class="item"><a href={{Route('frpvessel')}} class="post-image view image_hover"><img src="img/product/FRP-Vessel.jpg" alt="" class="img-responsive zoom_img_effect"></a><a href={{Route('frpvessel')}}>
            ...
            <div class="col-md-4 col-sm-8 service-info">
                <div class="item"><a href={{Route('electromageneticflowmeter')}} class="post-image view image_hover"><img src="img/product/Flow-meter.jpg" alt="" class="img-responsive zoom_img_effect"></a><a href={{Route('electromageneticflowmeter')}}>
            ...
            <div class="row">
            <div class="col-md-4 col-sm-8 service-info">
                <div class="item"><a href={{Route('roandufmembrane')}} class="post-image view image_hover"><img src="img/product/RO Antiscalant.jpg" alt="" class="img-responsive zoom_img_effect"></a><a href={{Route('roandufmembrane')}}>
            ...
            <div class="col-md-4 col-sm-8 service-info">
                <div class="item"><a href={{Route('watertreatmentaccessories')}} class="post-image view image_hover"><img src="img/product/Flocculants & Dechlorinator.jpg" alt="" class="img-responsive zoom_img_effect"></a><a href={{Route('watertreatmentaccessories')}}>
                ...
                <h6><a href={{Route('watertreatmentaccessories')}}>Read more</a></h6>
                </div>
            </div>
            <div class="col-md-4 col-sm-8 service-info">
                ...
                <div class="row g-4">
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.2s">
                        <div class="feature-item text-center border p-5">
                            <div>
                                <i class="fas text-primary fa-5x"> <img src="https://greengenesisbd.com/wp-content/uploads/elementor/thumbs/9981536-qc77fee5d48t9oymp4zi9bumnm9m9u55z56ij8xjxc.png" alt=""></i>
                            </div>
                            <a href="#" class="h4 d-block my-4">Accountability</a>
                            <p class="mb-0">We conduct all activities with our clients and employees in a transparent and accountable manner at all times. </p>
                        </div>
                    </div>
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.4s">
                        <div class="feature-item text-center border p-5">
                            <div>
                                <i class="fas text-primary fa-5x"> <img src="https://greengenesisbd.com/wp-content/uploads/elementor/thumbs/team-support-qc949z1eq183p8p1kik53vb9cpoz9dwpexz3a1xcm8.png" alt=""></i>
                            </div>
                            <a href="#" class="h4 d-block my-4">Teamwork</a>
                            <p class="mb-0">We encourage teamwork, diversity of talent, and experience amongst our colleagues and best solution for our clients.</p>
                        </div>
                    </div>
                    <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.6s">
                        <div class="feature-item text-center border p-5">
                            <div>
                                <i class="fas text-primary fa-5x"><img src="https://greengenesisbd.com/wp-content/uploads/elementor/thumbs/trustworthy-qc949zz8wv9e0unof0yrod2py3kch30fr2mkrbvyg0.png" alt=""></i>
                            </div>
                            <a href="#" class="h4 d-block my-4">Professional</a>
                            <p class="mb-0">We are committed to delivering excellence by methodically selecting the best resources and materials to ensure superior quality.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container-fluid project py-5">
            <div class="container py-5">
                <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                    <h3 class="hs"> <span class="underline ">OUR PROJECT </span>  </h3>
                </div>
                <div class="row g-5">
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-8">
                                    <div class="project-content mb-4">
                                        ...
                                        <a href="#" class="h4">ETP Plant</a>
                                        <p class="mb-0 mt-3">An Effluent Treatment Plant (ETP) is a facility that treats industrial wastewater so it can be safely released into the environment.</p>
                                    </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-8">
                                    <div class="project-content mb-4">
                                        ...
                                        <a href="#" class="h4">WTP Plant</a>
                                        <p class="mb-0 mt-3">A water treatment plant is a unit where raw water (or contaminated water from the source) is treated using technologies like Reverse Osmosis, UV Disinfection or Cartridge filtration to generate clean and safe water.</p>
                                    </div>
                                    <a class="btn btn-primary py-2 px-4" href="#">Read More</a>
                                </div>
                            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-8">
                                    <div class="project-content mb-4">
                                        ...
                                        <a href="#" class="h4">Swimming Pool</a>
                                        <p class="mb-0 mt-3">We provide the best price Swimming Pool Equipment, chemicals, water fountain, sauna, steam bath, jacuzzi suppliers company in Bangladesh.</p>
                                    </div>
                                    <a class="btn btn-primary py-2 px-4" href="#">Read More</a>
                                </div>
                            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-md-8">
                                    <div class="project-content mb-4">
                                        ...
                                        <p class="mb-0 mt-3">Iron Removal Plant (IRP) are able to remove metals, chemicals, manganese, hydrogen sulfide, and both ferrous and ferric iron reliably and continuously.</p>
                                    </div>
                                    <a class="btn btn-primary py-2 px-4" href="#">Read More</a>
                                </div>
                            </div>
