    ...
    <div class="container">
        <div class="row">
            <div class="col-md-4 col-sm-8 service-info " style="margin-top:20px;">
             <div class="item"><a href={{Route('electricmotor')}} class="post-image view image_hover">			<img src= "{{ asset('img/product/pump/Dynamic-Vertical-multistage-pump.png')}}" alt="" class="img-responsive zoom_img_effect"></a><a href={{Route('electricmotor')}}>
                   </a>
                </div>
            </div>
                ...
                <div class="tab-pane container active" id="home">
                    <div class="description">
                      <div class="row">
                        ...
                        <div class="col-md-6 ">
                          <img class="img-fluid" src="{{ asset('img/product/pump/SGT-Curve-01.png')}}" alt="Carve">
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6"> <img class="img-fluid" src="{{ asset('img/product/pump/SGT-Curve-02.png')}}" alt="Carve"></div>
                        <div class="col-md-6"> <img class="img-fluid" src="{{ asset('img/product/pump/SGT-Curve-03.png')}}" alt="Carve"></div>
    ...
    <div class="container my-5">
      <div class="additional-details my-5 ">
       <h3>Product Details</h3>
            ...
            <ul class="nav nav-tabs justify-content-left">
                <li class="nav-tabs">
                    <a class="nav-link active" data-toggle="tab" data-bs-toggle="tab" href="#home"> Model </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " data-toggle="tab" data-bs-toggle="tab" href="#menu1">Model</a>
                </li>
