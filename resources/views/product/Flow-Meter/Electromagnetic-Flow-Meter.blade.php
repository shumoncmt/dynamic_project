...
<body>
  ...
  <section class="diff-offer-wrapper">
    <div class="container">
      <div class="row ">
        <h2 style="margin-bottom:10px; margin-top:25px">Electromagnetic Flow Meter</h2>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 col-sm-8" style="margin-top: 50px; margin-left:15px">
                <h2>Electromagnetic Flow Meter</h2>
                ...
                <h5>Features</h5>
                <ul>
                  <li>Fast response and high stability.</li>
                  <li>High accuracy, 0.5%, 0.2% for flowrate.</li>
                  <li>Dual cavity housing to separate electronics part from wiring part.</li>
                  <li>AC power supply common use (85~265vac).</li>
                  <li>High visible backlit LCD for easy operation.</li>
                  <li>Communication: E. G. RS485, RS232C, HART, Profibus, MODBUS etc.</li>
                  <li>BI-direction measuring and totalizing.</li>
                </ul>
            ...
            <div class="tab-content mt-4 mb-3">
                <div class="tab-pane container active" id="home">
                    <div class="description">
                      <div class="row">
                         <p>The electromagnetic Flow meter is composed of a sensor and converter, works on Faraday”s electromagnetic indication principle, it has a dual cavity housing providing ease of wiring while isolating the electronics from the environment. LDG series continues the use of low-frequency excitation method and multiform lining allowing this magnetic flow meter to be applied to an even greater range of applications.</p>
                          <p> </p>
                          <h6>Standard specifications</h6>
                          <li>Measuring Range </li>
                          <li>The velocity range is 0.3m/s to 15m/s. The minimum measurable speed can be one percent(1%) of the full range. </li>
                          <li>Analog Output </li>
                          <li>Current output: Fully-isolated 0~10mA/4~20mA </li>
                          <li>Load resistance: O to 1.5k; 4~20mA, 0~750 at 4~20mA </li>
                          <li>Base error: Add minus 10uA on top of the measurement error </li>
                          <li>Frequency Output </li>
                          <li>Frequency output is proportional to the flow percentage of the full range. It Provides fully isolated transistor open collector frequency output ranged from 1 to 5000Hz, the external DC power supply should not exceed 35V and maximum collector current is 250mA.</li>
                          <p> </p>
                          <h6>Pulse output</h6>
                          <p>The converter can output up to 5000cp/s pulse series, which is dedicated to external totalization. Pulse factor is defined as pulse width is selectable from 16ms, 33ms, 66mm, and so on. Photo-coupler isolated transistor open collector circuit is used for pulse output. The external DC power supply should not exceed 35V and maximum collector current is 250mA
                          </p>
                            <p> </p>
                            <h6>Showing Flow Direction & Range</h6>
                            <p>The converter is capable of measuring both forward and reverse flow and recognizing its direction. The converter output 0Vlow level for forward flow, while 12V high level for reverse flow. Alarm Output 
                              Two channel of photo-coupler isolated open collector circuit are used for alarm signal output. There are two alarm outputs: High limit alarm and low limit alarm. The external DC power supply should not exceed 35V and maximum collector current is 25OmA</p>
                            <p> </p>
                            <h6>Communication</h6>
                            <ul>
                              <li>RS232C, RS485, HART, PROFIBUS, MODBUS </li>
                              <li>The RS232C, RS485, HART, PROFIBUS, MODBUS Communication interface are embedded in the converter. Surge absorber is optional to protect the interface and converter.</li>
                            </ul>
                      </div>
                    </div>
                </div>
                    ...
                    <div class="review">
                      <div class="table-responsive">
                        <table class="table table-bordered border-primary">
                          ...
                          <tbody>
                            <tr >
                              <td width="74">AYT- 10S</td>
                              <td rowspan="2" width="89">0.0283</td>
                              <td rowspan="2" width="91">4.24</td>
                              <td rowspan="2" width="81">10</td>
                              <td width="83">4111001</td>
                            </tr>
                            <tr>
                              <td>AFT- 10L</td>
                              <td>4111002</td>
